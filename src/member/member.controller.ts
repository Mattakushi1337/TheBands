import { Controller, Param, Delete, UseGuards, Req, ForbiddenException, NotFoundException, Get } from '@nestjs/common';
...
export class MemberController {
  ...
  @UseGuards(JwtGuard)
  @Get(':bandId')
  async getAllMembers(@Param('bandId') bandId: string): Promise<Member[]> {
    const members = await this.memberService.getAllMembers(parseInt(bandId));
    return members;
  }
}
